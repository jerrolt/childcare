...
<head>
	...
	<link href="{{ asset('css/tmp/css/bootstrap-min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/tmp/app.css') }}" rel="stylesheet">
</head>
<body>
    <div id="Container">
    ...
    <script src="{{ asset('js/tmp/lib/jquery.min.js') }}"></script> 
    <script src="{{ asset('js/tmp/lib/bootstrap.min.js') }}"></script>
    <script src="{{ asset('js/tmp/scripts/es6-shim.js') }}"></script>
    <script src="{{ asset('js/tmp/scripts/websdk.client.bundle.min.js') }}"></script>
    <script src="{{ asset('js/tmp/scripts/fingerprint.sdk.min.js') }}"></script>
    <script src="{{ asset('js/tmp/app.js') }}"></script>
